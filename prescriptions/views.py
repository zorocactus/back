...
from .models import Prescription, QRToken, Medication
...
from prescriptions.permissions import IsCaretaker, IsCaretakerOfPatient, IsPharmacyOrderOwner
...
class PrescriptionViewSet(viewsets.ModelViewSet):
    ...
    @action(detail=False, methods=['get'], url_path='caretaker-patients')
    def caretaker_patients_prescriptions(self, request):
        """
        GET /api/prescriptions/caretaker-patients/
        ...
        try:
            ...
            return Response({'error': 'Module caretaker introuvable.'}, status=500)
